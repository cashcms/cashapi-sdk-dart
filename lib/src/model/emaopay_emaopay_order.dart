...
part 'emaopay_emaopay_order.g.dart';
...
class EmaopayEmaopayOrder {
  /// Returns a new [EmaopayEmaopayOrder] instance.
  EmaopayEmaopayOrder({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EmaopayEmaopayOrder &&
     other.amount == amount &&
  ...
  factory EmaopayEmaopayOrder.fromJson(Map<String, dynamic> json) => _$EmaopayEmaopayOrderFromJson(json);

  Map<String, dynamic> toJson() => _$EmaopayEmaopayOrderToJson(this);
